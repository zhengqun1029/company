...
/**
 * 城市虚拟卡信息返回 VirtualCardInfoQueryModel 数据库表：VirtualCardAccount
 */
public class VirtualCardInfoQueryModel {
	/**
	 * 虚拟卡卡片使用说明 表字段 : lty_virtual_card_setting.card_introduction
	 */
	private String cardIntroduction;

	/**
	 * 城市虚拟卡图片样式url 表字段 : lty_virtual_card_setting.pics
	 */
	private String pics;

	/**
	 * 自增主键 表字段 : lty_virtual_card_account.id
	 */
	private Long id;

	/**
	 * 创建时间 表字段 : lty_virtual_card_account.gmt_create
	 */
	private Date gmtCreate;

	/**
	 * 最后修改时间 表字段 : lty_virtual_card_account.gmt_modified
	 */
	private Date gmtModified;

	/**
	 * 用户id，对应base_user 表字段 : lty_virtual_card_account.user_id
	 */
	private Integer userId;

	/**
	 * 用户名称 表字段 : lty_virtual_card_account.user_name
	 */
	private String userName;

	/**
	 * 城市编码 表字段 : lty_virtual_card_account.city_code
	 */
	private String cityCode;

	/**
	 * 虚拟卡号 表字段 : lty_virtual_card_account.card_no
	 */
	...
	/**
	 * 是否被冻结（0：否； 1：是） 表字段 : lty_virtual_card_account.status
	 */
	 ...
	 *
	 * @param id
	 *            the value for lty_virtual_card_account.id, 自增主键
	 */
	 ...
	 *
	 * @param gmtCreate
	 *            the value for lty_virtual_card_account.gmt_create, 创建时间
	 */
	 ...
	 *
	 * @param gmtModified
	 *            the value for lty_virtual_card_account.gmt_modified, 最后修改时间
	 */
	 ...
	 *
	 * @param userId
	 *            the value for lty_virtual_card_account.user_id,
	 *            用户id，对应base_user
	 */
	 ...
	 *
	 * @param userName
	 *            the value for lty_virtual_card_account.user_name, 用户名称
	 */
	 ...
	 *
	 * @param cityCode
	 *            the value for lty_virtual_card_account.city_code, 城市编码
	 */
	 ...
	 *
	 * @param cardNo
	 *            the value for lty_virtual_card_account.card_no, 虚拟卡号
	 */
	 ...
	 *
	 * @param balance
	 *            the value for lty_virtual_card_account.balance,
	 */
	 ...
	 *
	 * @param status
	 *            the value for lty_virtual_card_account.status, 是否被冻结（0：否； 1：是）
	 */
	 ...
	 *
	 * @param field1
	 *            the value for lty_virtual_card_account.field1,
	 */
	 ...
	 *
	 * @param field2
	 *            the value for lty_virtual_card_account.field2,
	 */
	 ...
	 *
	 * @param field3
	 *            the value for lty_virtual_card_account.field3,
	 */
	 ...
	 *
	 * @param cardIntroduction
	 *            the value for lty_virtual_card_setting.card_introduction,
	 *            虚拟卡卡片使用说明
	 */
	 ...
	 *
	 * @param pics
	 *            the value for lty_virtual_card_setting.pics, 城市虚拟卡图片样式url
	 */
