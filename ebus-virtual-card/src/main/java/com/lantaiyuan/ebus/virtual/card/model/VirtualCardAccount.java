 ...
 */
public class VirtualCardAccount extends Model{
    ...
    public VirtualCardAccount(Integer userId, String cityCode, String cardNo, BigDecimal balance) {
		super();
		this.userId = userId;
    ...
    public VirtualCardAccount(Integer userId,String userName, String cityCode, String cardNo, BigDecimal balance) {
		super();
